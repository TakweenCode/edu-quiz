...
const Wheel: React.FC<WheelProps> = ({ questions, answeredIds, colors, onSelectQuestion }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full max-w-md mx-auto aspect-square p-4">
      ...
      {/* Wheel Container */}
      {/* Changed drop-shadow-2xl to shadow-2xl for better mobile rendering */}
      <div className="relative w-full h-full shadow-2xl rounded-full bg-white overflow-hidden border-2 border-slate-100">
        <svg
            ref={wheelRef}
            viewBox="0 0 100 100"
      ...
      <button
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full flex items-center justify-center text-slate-800 font-bold shadow-xl z-10 hover:scale-105 active:scale-95 transition-transform disabled:opacity-50 disabled:cursor-not-allowed border-2 border-slate-100"
      >
